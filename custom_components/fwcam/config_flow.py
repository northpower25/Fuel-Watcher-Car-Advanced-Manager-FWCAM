        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_FUEL_TYPE, default=DEFAULT_FUEL_TYPE): vol.In(["e5", "e10", "diesel", "all"]),
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_FUEL_TYPE, default=current.get(CONF_FUEL_TYPE, self.config_entry.data.get(CONF_FUEL_TYPE, DEFAULT_FUEL_TYPE))): vol.In(["e5", "e10", "diesel", "all"]),
